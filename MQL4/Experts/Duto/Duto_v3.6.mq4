...
{  
   ...
   //check for an entry
   //SignalEntry = TraditionalStrategyEntry();
   SignalEntry = SniperStrategyEntry();
...

{
   ...
   //check for an exit
   //SignalExit = TraditionalStrategyExit();
   SignalExit = SniperStrategyExit();
...
void SniperStrategy()
{
      ...
      && SniperCockedNeutral == false)
   {
      ...
      //SellSafetyTradeTraditionalStrategy = false;
      //BuySafetyTradeTraditionalStrategy = true;
      //NeutralSafetyTradeTraditionalStrategy = false;

      CurrentStrategy ="SNIPER_BUY";
      ...
      && SniperCockedNeutral == false)
   {
      ...
      //SellSafetyTradeTraditionalStrategy = true;
      //BuySafetyTradeTraditionalStrategy = false;
      //NeutralSafetyTradeTraditionalStrategy = false;

      CurrentStrategy ="SNIPER_SELL";
      ...
      )
   {
      ...
      //SellSafetyTradeTraditionalStrategy = true;
      //BuySafetyTradeTraditionalStrategy = false;
      //NeutralSafetyTradeTraditionalStrategy = true;
      ...
      + " NeutralStrategyActive: " + NeutralStrategyActive); */
      //Print("NeutralSafetyTradeTraditionalStrategy: " + NeutralSafetyTradeTraditionalStrategy);   
   }
}

ENUM_SIGNAL_ENTRY SniperStrategyEntry()
{
   //ENTRY LOGIC
   ...
   {
      //Print("TraditionalStrategyEntry: UseTradingHours && !IsOperatingHours");
      SignalEntry = SIGNAL_ENTRY_NEUTRAL;
      ...
      )
   {
      ...
      " BuySafetyTradeTraditionalStrategy: " + BuySafetyTradeTraditionalStrategy);
      ...
      )
   {
      ...
      "SellTradeActive: " + SellTradeActive + 
      " BuyTradeActive: " + BuyTradeActive + 
      " SellSafetyTradeTraditionalStrategy: " + SellSafetyTradeTraditionalStrategy);
...
ENUM_SIGNAL_EXIT SniperStrategyExit()
{ 
   //EXIT LOGIC
   ...
   //BUY EXIT
   if (
      //AskThePlotsSniperStrategyExit(UpperTimeFrame + 10 + TradeExitPlot, 1, 1, "BUY_SNIPER_EXIT") == "EXIT A SNIPER TRADE BUY"
      AskThePlotsSniperStrategyExit(UpperTimeFrame + 10 + 10 + TradeExitPlot, 1, 1, "BUY_SNIPER_EXIT") == "EXIT A SNIPER TRADE BUY"
      //&& BuyStrategyActive == true 
      && BuyTradeActive == true
   ...
   //SELL EXIT
   if (
      //AskThePlotsSniperStrategyExit(UpperTimeFrame + 10 + TradeExitPlot, 1, 1, "SELL_SNIPER_EXIT") == "EXIT A SNIPER TRADE SELL"
      AskThePlotsSniperStrategyExit(UpperTimeFrame + 10 + 10 + TradeExitPlot, 1, 1, "SELL_SNIPER_EXIT") == "EXIT A SNIPER TRADE SELL"
      //&& SellStrategyActive == true 
      && SellTradeActive == true
...
string AskThePlotsSniperStrategyEntry(int Idx, int CndleStart, int CmbndHstryCandleLength, string OverallStrategy)
{
   string result = "";
...
string AskThePlotsSniperStrategyExit(int Idx, int CndleStart, int CmbndHstryCandleLength, string OverallStrategy)
{
   string result = "";
